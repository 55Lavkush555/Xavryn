...
export default function Home() {
  ...
  return (
    <div className="container">
      <nav>
        <div className="logo"><img src="./images/logo.png" alt="" /> Xavryn</div>

        <div className="buttons-container">
          <button className="login"><Link href={"/"}>Sign in</Link></button>
          <button className="signup"><Link href={"/"}>Get started</Link></button>
        </div>
      </nav>

      <div className="content">
        <h1>Connect Beyond</h1>
        <h1 className="blue">Boundries</h1>
      ...
      <div className="features">
        <div className="content">
          ...
          <h1 className="blue">communicate better</h1>
      ...
      <div className="cta">
        <div className="content">
          ...
          <h1 className="blue">communication?</h1>
